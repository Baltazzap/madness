...
async def roles_command(ctx):
    ...
    # Разбиваем текст на части, чтобы не превысить 1024 символа на поле
    # Поле 1: Администрация
    embed.add_field(
        name="👑 АДМИНИСТРАЦИЯ",
        value=(
    ...
    # Поле 5: Косметические (для тех, кто не любит кнопки)
    embed.add_field(
        name="🎭 КОСМЕТИЧЕСКИЕ",
        value=(
